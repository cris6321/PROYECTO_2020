...
/*				num = atoi(respuesta);*/
				/*char registrar[80];*/
				if(num == 0){
					sprintf(consulta, "INSERT INTO Jugador VALUES (NULL,'%s','%s');",username, password);
					printf("%s\n", consulta);
/*					strcpy(registrar, "INSERT INTO Jugador (id, nom, pword, ganadas, jugadas) VALUES ('");					*/
/*					strcat(registrar, "'0,");*/
/*					strcat(registrar, username);*/
/*					strcat(registrar, "',");*/
/*					strcat(registrar, password);*/
...
/*					return 1;*/
			...
			else if(codigo==5){ //Consulta polet: partidas ganadas del ganador introducido por teclado
				char ganador[20];
				printf("Codigo: %d\n", codigo);
				strcpy(ganador,p);
